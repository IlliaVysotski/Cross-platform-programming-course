...
/**
 * Class which create Main Grid Pane to Scene(Program)
...
public class MainWindow {
    ...
    //private Button buttonPlayCinema;
    private TextField inputNewGoodsName;
    //private TextField inputNewAmount;
   // private TextField inputURLDownload;
    //private TextField inputPlayCinema;
    ...
    private void InitialControllers() {
        ...
        //buttonDownloadFile = new Button("Download File");
        //buttonPlayCinema = new Button("Play Cinema");
        inputNewGoodsName = new TextField();
        inputNewGoodsName.setPromptText("Enter name of product");
        //inputNewAmount = new TextField();
        //inputURLDownload = new TextField();
        //inputPlayCinema = new TextField();
    ...
    private void SetPosition() {
        //controlPane.add(inputURLDownload, 0, 0);
        //controlPane.add(buttonDownloadFile, 0, 1);
        //controlPane.add(inputPlayCinema, 0, 2);
        //controlPane.add(buttonPlayCinema, 0, 3);
        controlPane.add(inputNewGoodsName, 0, 0);//1,0
        //controlPane.add(inputNewAmount, 1, 1);
        controlPane.add(buttonAddMatches, 0, 1);//1,2
        controlPane.add(buttonAddBread, 0, 2);//1,3
        controlPane.add(InformationLabel, 0, 4);
    ...
    private void SetHandlers() {
        ...
        //buttonPlayCinema.setOnAction(event -> ButtonPlayCinemaClick());
        ...
        try{
            if(listOfGoods.getSelectionModel().getSelectedItem() != null) {
                ...
                if(!customer.buyGoods(listOfGoods.getSelectionModel().getSelectedItem(), customer))
                {
                    ...
                    InformationLabel.setText("Payment successfully proceed." +"\n"+ "Your current balance is " + customer.money + "$");
